...
import com.example.habittrackerapplication.databinding.FragmentTabViewTwoBinding
 ...
 * Use the [TabViewTwoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TabViewTwoFragment : Fragment() {
    private var param1: String? = null
    private var param2: String? = null
    lateinit var binding:FragmentTabViewTwoBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentTabViewTwoBinding.inflate(layoutInflater,container,false)
    ...
    companion object {
         ...
         * @return A new instance of fragment TabViewTwoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            TabViewTwoFragment().apply {
